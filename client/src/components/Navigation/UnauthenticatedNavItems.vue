<template>
  <div>
    ...
    <md-list-item>
      ...
      <span class="md-list-item-text sidebar-items">All Courses</span>
    </md-list-item>

    <md-list-item>
      <!-- <md-icon>error</md-icon> -->
      <span class="md-list-item-text sidebar-items">Blog</span>
    </md-list-item>
    <md-list-item>
      <!-- <md-icon>error</md-icon> -->
    ...
    <md-list-item>
      <!-- <md-icon>error</md-icon> -->
      <span class="md-list-item-text sidebar-items">Support</span>
    </md-list-item>
  </div>
</template>
